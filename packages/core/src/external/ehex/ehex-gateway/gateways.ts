...
//TODO: 1593 - Need access to pre-prod ehex to get the ehex versions of these urls.
/*
 * Gateways with this url require the Metriport OID instead of the Initiator OID in the SOAP body.
 */
const requiresMetriportOidUrl: string[] = [];
...
// TODO: 1850 - Let's remove this and most other logic in this file
export function getInitiatorOid(
