...
import { DEFAULT_COLOR, DEFAULT_SETTINGS } from "@metriport/shared/domain/cohort";
...
import * as getSettingsModule from "../../patient/get-settings";
import { CohortCreateCmd } from "@metriport/shared/domain/cohort";

jest.mock("../get-cohort");
const mockGetCohortByNameSafe = getCohortByName as jest.MockedFunction<typeof getCohortByName>;
const mockCohortModelCreate = jest.spyOn(CohortModel.CohortModel, "create");
const mockValidateMonitoringSettingsForCx = jest.spyOn(
  getSettingsModule,
  "validateCohortSettingsOrFail"
);
