...
import { EhexOutboundPatientDiscoveryRespSuccessful } from "../xcpd/process/types";
...
export const expectedXcpdResponse: EhexOutboundPatientDiscoveryRespSuccessful = {
  ...
  patientMatches: [
    {
      ...
      custodianOid: "2.16.840.1.113883.3.9621",
    },
  ],
};

const firstPatientMatch = expectedXcpdResponse.patientMatches[0];
if (!firstPatientMatch) {
  throw new Error("Expected patient match not found");
}

const firstPatientResource = firstPatientMatch.patientResource;

export const expectedMultiNameAddressResponse: EhexOutboundPatientDiscoveryRespSuccessful = {
  ...
  patientMatches: [
    {
      ...
      patientResource: {
        ...
        gender: firstPatientResource.gender,
        birthDate: firstPatientResource.birthDate,
        address: [
          ...(firstPatientResource.address ?? []),
          {
