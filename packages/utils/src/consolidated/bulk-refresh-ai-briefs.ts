...
import { PatientRecord, readPatientIdsFromCsvFile } from "../shared/ids";
...
async function main({
  ...
  const patientRecords = readPatientIdsFromCsvFile(csvFilePath);
