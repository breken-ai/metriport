 ...
 *
 * Run it with:
 * - ts-node src/analytics-platform 3-ingest-from-merged-csvs -mrg <mergeCsvJobId>
 *
 * Example:
 * - ts-node src/analytics-platform 3-ingest-from-merged-csvs -mrg 2025-08-08T04-38-04
 */
