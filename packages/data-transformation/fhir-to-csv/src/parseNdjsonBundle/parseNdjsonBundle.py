...
def parse(input_path: str, outputs_folder: str, include_header: bool) -> list[str]:
    # First, extract patient_id from bundle by finding Patient resource
    patient_id = None
            ...
            try:
                ...
                if resource.get('resourceType') == 'Patient':
                    ...
                    if resource_id:
                        ...
                        patient_id = resource_id.replace('Patient/', '') if resource_id.startswith('Patient/') else resource_id
                        break
            ...
            for line in infile:
                try:
                    ...
                    if resource.get('resourceType') == resource_type:
                        # Inject patient_id from bundle context for Binary resources
                        if resource_type == 'Binary' and patient_id:
