...
<Tip>
  **Testing Webhooks**: In sandbox mode, you can test your
  webhook integration with realistic patient notification
  events (Patient Admit, Transfer, Discharge) using the
  dashboard testing tool. Learn more in the [Webhook Testing
  section](/medical-api/getting-started/sandbox#webhook-testing)
  of our sandbox documentation.
</Tip>
